...
/**
 * an instance of this class is created for every plugin (including the main craftyrepl one) that depends on craftyrepl, because
 * it will have to have in its plugin.yml the following:<br>
 * "main: craftyrepl.ClojurePlugin"
 *
 */
	...
	public boolean start() {
		...
		if ( selfPluginName.equals( pluginName ) ) {
			...
			success = loadClojureNameSpace(pluginName+".core");
                ...
                loadClojureNameSpace ("craftyrepl.core");
...
/*in plugin.yml of your clojure plugin which depends on craftyrepl, these are required:
 * 
 * main: craftyrepl.ClojurePlugin
 * depend: [craftyrepl]
 * 
